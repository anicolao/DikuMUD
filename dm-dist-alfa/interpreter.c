...
void assign_command_pointers ( void )
{
	...
	COMMANDO(65,POSITION_STANDING,do_fill,0);
	COMMANDO(66,POSITION_RESTING,do_grab,0);
	COMMANDO(67,POSITION_RESTING,do_remove,0);
	COMMANDO(68,POSITION_RESTING,do_put,0);
	COMMANDO(69,POSITION_DEAD,do_shutdow,24);
	COMMANDO(70,POSITION_SLEEPING,do_save,0);
	COMMANDO(71,POSITION_FIGHTING,do_hit,0);
	COMMANDO(72,POSITION_SLEEPING,do_string,23);
	COMMANDO(73,POSITION_RESTING,do_give,0);
	COMMANDO(74,POSITION_DEAD,do_quit,0);
	COMMANDO(75,POSITION_DEAD,do_stat,21);
	COMMANDO(76,POSITION_SLEEPING,do_set,23);
	COMMANDO(77,POSITION_DEAD,do_time,0);
	COMMANDO(78,POSITION_DEAD,do_load,22);
	COMMANDO(79,POSITION_DEAD,do_purge,22);
	COMMANDO(80,POSITION_DEAD,do_shutdown,24);
	COMMANDO(81,POSITION_DEAD,do_idea,0);
	COMMANDO(82,POSITION_DEAD,do_typo,0);
	COMMANDO(83,POSITION_DEAD,do_bug,0);
	COMMANDO(84,POSITION_RESTING,do_whisper,0);
	COMMANDO(85,POSITION_SITTING,do_cast,1);
	COMMANDO(86,POSITION_DEAD,do_at,21);
	COMMANDO(87,POSITION_RESTING,do_ask,0);
	COMMANDO(88,POSITION_RESTING,do_order,1);
	COMMANDO(89,POSITION_RESTING,do_sip,0);
	COMMANDO(90,POSITION_RESTING,do_taste,0);
	COMMANDO(91,POSITION_DEAD,do_snoop,21);
	COMMANDO(92,POSITION_RESTING,do_follow,0);
	COMMANDO(93,POSITION_STANDING,do_not_here,1);
	COMMANDO(94,POSITION_STANDING,do_not_here,1);
	COMMANDO(95,POSITION_RESTING,do_action,0);
	COMMANDO(96,POSITION_DEAD,do_advance,23);
	COMMANDO(97,POSITION_SITTING,do_action,0);
	COMMANDO(98,POSITION_RESTING,do_action,0);
	COMMANDO(99,POSITION_STANDING,do_action,0);
	COMMANDO(100,POSITION_SITTING,do_open,0);
	COMMANDO(101,POSITION_SITTING,do_close,0);
	COMMANDO(102,POSITION_SITTING,do_lock,0);
	COMMANDO(103,POSITION_SITTING,do_unlock,0);
	COMMANDO(104,POSITION_STANDING,do_leave,0);
	...
	COMMANDO(110,POSITION_RESTING,do_action,0);
	COMMANDO(111,POSITION_STANDING,do_action,0);
	COMMANDO(112,POSITION_RESTING,do_action,0);
	COMMANDO(113,POSITION_STANDING,do_action,0);
	...
	COMMANDO(126,POSITION_RESTING,do_action,0);
	COMMANDO(127,POSITION_STANDING,do_action,0);
	...
	COMMANDO(136,POSITION_RESTING,do_action,0);
	COMMANDO(137,POSITION_SLEEPING,do_action,0);
	COMMANDO(138,POSITION_STANDING,do_action,0);
	COMMANDO(139,POSITION_RESTING,do_action,0);
	COMMANDO(140,POSITION_RESTING,do_action,0);
	COMMANDO(141,POSITION_STANDING,do_action,0);
	...
	COMMANDO(145,POSITION_RESTING,do_action,0);
	COMMANDO(146,POSITION_STANDING,do_action,0);
	COMMANDO(147,POSITION_RESTING,do_action,0);
	COMMANDO(148,POSITION_RESTING,do_action,0);
	COMMANDO(149,POSITION_STANDING,do_action,22);
	COMMANDO(150,POSITION_STANDING,do_write,1);
	COMMANDO(151,POSITION_RESTING,do_grab,1);
	COMMANDO(152,POSITION_FIGHTING,do_flee,1);	
	COMMANDO(153,POSITION_STANDING,do_sneak,1);	
	COMMANDO(154,POSITION_RESTING,do_hide,1);	
	COMMANDO(155,POSITION_STANDING,do_backstab,1);	
	COMMANDO(156,POSITION_STANDING,do_pick,1);	
	COMMANDO(157,POSITION_STANDING,do_steal,1);	
	COMMANDO(158,POSITION_FIGHTING,do_bash,1);	
	COMMANDO(159,POSITION_FIGHTING,do_rescue,1);
	COMMANDO(160,POSITION_FIGHTING,do_kick,1);
	...
	COMMANDO(164,POSITION_RESTING,do_action,0);
	COMMANDO(165,POSITION_RESTING,do_practice,1);
	COMMANDO(166,POSITION_RESTING,do_action,0);
	COMMANDO(167,POSITION_SITTING,do_examine,0);
	COMMANDO(168,POSITION_RESTING,do_get,0); /* TAKE */
	COMMANDO(169,POSITION_SLEEPING,do_info,0);
	COMMANDO(170,POSITION_RESTING,do_say,0);
	COMMANDO(171,POSITION_RESTING,do_practice,1);
	COMMANDO(172,POSITION_RESTING,do_action,0);
	COMMANDO(173,POSITION_SITTING,do_use,1);
	COMMANDO(174,POSITION_DEAD,do_where,1);
	COMMANDO(175,POSITION_DEAD,do_levels,0);
	COMMANDO(176,POSITION_DEAD,do_reroll,24);
	COMMANDO(177,POSITION_SITTING,do_action,0);
	COMMANDO(178,POSITION_SLEEPING,do_emote,1);
	COMMANDO(179,POSITION_RESTING,do_action,0);
	COMMANDO(180,POSITION_RESTING,do_action,0);
	COMMANDO(181,POSITION_RESTING,do_action,0);
	COMMANDO(182,POSITION_SLEEPING,do_action,0);
	...
	COMMANDO(202,POSITION_RESTING,do_consider,0);
	COMMANDO(203,POSITION_RESTING,do_group,1);
	COMMANDO(204,POSITION_DEAD,do_restore,22);
	COMMANDO(205,POSITION_DEAD,do_return,0);
	COMMANDO(206,POSITION_DEAD,do_switch,23);
	COMMANDO(207,POSITION_RESTING,do_quaff,0);
	COMMANDO(208,POSITION_RESTING,do_recite,0);
	COMMANDO(209,POSITION_DEAD,do_users,21);
	COMMANDO(210,POSITION_STANDING,do_pose,0);
	COMMANDO(211,POSITION_SLEEPING,do_noshout,22);
	COMMANDO(212,POSITION_SLEEPING,do_wizhelp,21);
	COMMANDO(213,POSITION_DEAD,do_credits,0);
	COMMANDO(214,POSITION_DEAD,do_compact,0);
	COMMANDO(215,POSITION_DEAD,do_wizlock,24);
	COMMANDO(216,POSITION_DEAD,do_notell,22);
	COMMANDO(217,POSITION_DEAD,do_noemote,22);
	COMMANDO(218,POSITION_DEAD,do_freeze,23);
	COMMANDO(219,POSITION_DEAD,do_goto,24);
...
/* Generate a summary of the Barsoom world state */
void send_barsoom_state(struct descriptor_data *d)
{
	...
	for (i = 0; i <= top_of_zone_table; i++) {
		if (zone_table[i].top > 0) {  /* Exclude terminator zones */
			zone_count++;
		}
	}
